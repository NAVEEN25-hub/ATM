...
public class Withdrawl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Integer.parseInt(acc) > Integer.parseInt(amount)) {
			...
			if(rs1>0) {
				out.print("Withdraw SuccessFully");
				...
				out.print("You Can Withdrawl Only 100's ");
				out.print("<br><br><a href = 'Withdrawl.jsp'>BACK</a>");
			}
		}
			else {
				out.print("Enter Less Than Available Balance");
				out.print("<br><br><a href = 'Withdrawl.jsp'>BACK</a>");
			}
		}
		catch(Exception e) {
